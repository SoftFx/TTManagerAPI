...
namespace rTTManApi
{
    public struct AssetDailySnapshot
    {
        string Currency;
        decimal Amount;
        decimal FreeAmount;
        decimal LockedAmount;
        decimal CurrencyToUsdConversionRate;
        decimal UsdToCurrencyConversionRate;
        DateTime Timestamp;

        AssetDailySnapshot(AssetSnapshot asset, DateTime timestamp)
        {
